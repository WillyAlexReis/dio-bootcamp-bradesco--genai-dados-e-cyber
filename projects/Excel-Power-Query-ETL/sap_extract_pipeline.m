let
    Fonte = Excel.Workbook(File.Contents("C:\Users\willy\Documents\GitHub\dio-bootcamp-bradesco--genai-dados-e-cyber\projects\Excel-Power-Query-ETL\nintendo-sending-packages.xlsx"), null, true),
    ...
    #"Colunas Renomeadas1" = Table.RenameColumns(#"Colunas Reordenadas",{{"Preço Unit Price", "Unit Price"}, {"Multiplicação", "Total price"}}),
